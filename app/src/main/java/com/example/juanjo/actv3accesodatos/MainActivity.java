package com.example.juanjo.actv3accesodatos;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void guardarPreferencias() {
        ...
        editor.putBoolean("Masculino", chico);
        editor.putBoolean("Femenino", chica);
        editor.commit();
    ...
    public void cargarPreferencias(){
        ...
        if (misPreferencias.getBoolean("Masculino",false)){
            txtSexo.setText("Eres de sexo masculino");
        } else {
            txtSexo.setText("Eres de sexo femenino");
        }
